...
public class NewInstanceComponentDelegate extends NewActionDelegate{

	public NewInstanceComponentDelegate() {}
	public NewInstanceComponentDelegate(SourceEditor editor) {
		super(editor);
	}
	...
	public boolean checkEnabled(GeneralEditor editor1) {
        ...
        if (ReferenceUtilities.checkType(ref.getType(), ReferenceUtilities.REF_HARDWARE_MODULE) == 0){
        	return true;
        }
        return false;
	}
	...
	public static class NewHandler extends GeneralHandler {
		...
		public GeneralEditorActionDelegate createDelegate(GeneralEditor editor) {
			return new NewInstanceComponentDelegate((SourceEditor)editor);
		}
