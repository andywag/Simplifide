 ...
 * All Right Reserved.
 ******************************************************************************/
package com.simplifide.core.refactor.port.add;
...
public class AddPortRefactorProcessor extends PortRefactorProcessor{

    private static final String ID = CoreActivator.PLUGIN_ID + "editors.refactor.rename.AddPortRefactorProcessor";
    
        
    public AddPortRefactorProcessor(ReferenceItem<Entity> entityRef , SourceEditor editor) {
    ...
    protected List<SourceMatch> createInstanceConnectionChange(ConnectorHolder holder) {
    	...
    	wrap.addPorts(this.getInstanceWrapDelta());
