...
public class RenameRefactoring extends Refactoring{
    ...
    private RenameRefactorProcessor processor;
    
    public RenameRefactoring(RenameRefactorProcessor processor) {
    ...
    public void setProcessor(RenameRefactorProcessor processor) {
        this.processor = processor;
    }
    public RenameRefactorProcessor getProcessor() {
        return processor;
    }
