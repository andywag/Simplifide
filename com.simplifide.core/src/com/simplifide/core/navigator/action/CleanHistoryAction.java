...
public class CleanHistoryAction extends Action {

	private CleanHistoryActor actor;
	
	public CleanHistoryAction(String name, CleanHistoryActor actor) {
		super(name);
		this.actor = actor;
	}
	...
	public interface CleanHistoryActor {
