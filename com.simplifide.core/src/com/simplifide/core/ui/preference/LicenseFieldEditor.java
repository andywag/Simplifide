...
public class LicenseFieldEditor extends FieldEditor{
     ...
     * @since 2.0
     */
    public LicenseFieldEditor(String name, String labelText, int width,
     ...
     * @param parent the parent of the field editor's control
     */
    public LicenseFieldEditor(String name, String labelText, Composite parent) {
