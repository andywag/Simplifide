 ...
 * </p> 
 */
public abstract class SourceOutlineContentPage extends Page implements
        IContentOutlinePage, ISelectionChangedListener {
    private ListenerList selectionChangedListeners = new ListenerList();

    private SourceTreeViewer treeViewer;

    /**
     * Create a new content outline page.
     */
    protected SourceOutlineContentPage() {
        super();
    }
    ...
    public void createControl(Composite parent) {
        treeViewer = new SourceTreeViewer(parent, SWT.MULTI | SWT.H_SCROLL
                | SWT.V_SCROLL);
     ...
     */
    protected SourceTreeViewer getTreeViewer() {
        return treeViewer;
    }
