 ...
 */
public class SourceNumberRule implements IRule {
	 ...
	 */
	public SourceNumberRule(IToken token) {
	...
	protected boolean checkChar(char uchar) {
		if (Character.isDigit(uchar) || uchar =='_') return true;
		return false;
	}
