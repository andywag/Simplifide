...
class initiator_parent extends vmm_xactor;
   ...
   vmm_tlm_initiator_socket#(initiator_parent, my_trans) socket = new(this, "initiator_P_put");
...
class target_parent extends vmm_xactor;
   target target_c;
   vmm_tlm_target_socket#(target_parent, my_trans) socket = new(this, "target_P_put");
