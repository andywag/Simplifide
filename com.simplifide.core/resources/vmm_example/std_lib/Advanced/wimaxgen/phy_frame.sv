...
class phy_frame extends vmm_data;
  ...
  function set_cfg(phy_tb_config phy_cfg);
    this.phy_cfg = phy_cfg;
    this.blue_print_super_zone.set_cfg(phy_cfg);
  endfunction
  ...
  virtual function string psdisplay(string prefix = "");
    string result;
    result = {$psprintf("\n--- %s --- %s --- Frame #%0d  --------------------------------------------\n", 
                        prefix, this.get_typename(), frame_index), 
