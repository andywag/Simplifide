...
public class SubTypeVar extends TypeVar {
    
    
    private ReferenceItem<? extends TypeVar> typeReference;
    
    public SubTypeVar() {}
    public SubTypeVar(String name) {
        super(name);
    }
    
    public SubTypeVar(String name, ReferenceItem<? extends TypeVar> ref) {
        super(name);
    ...
    public List<ReferenceItem> findVarPrefixItemList(ModuleObjectFindItem item, int type) {
        if (this.getTypeReference() != null) {
            return this.getTypeReference().findPrefixItemList(item,type);
        }
        return new ArrayList<ReferenceItem>();
    ...
    public List<ReferenceItem> findVarParenItemList(ModuleObjectFindItem item, int type) {
        if (this.getTypeReference() != null) {
            return this.getTypeReference().findPrefixItemList(item,type);
        }
        return new ArrayList<ReferenceItem>();
