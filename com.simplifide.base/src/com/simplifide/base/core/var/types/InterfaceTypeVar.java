...
public class InterfaceTypeVar<T extends SystemVar> extends TypeVar<T>
{


	private ReferenceItem<InterfaceInstanceModule> classR;
	
    public InterfaceTypeVar() {}
    public InterfaceTypeVar(ReferenceItem<InterfaceInstanceModule> classR){
	...
	public void setClassR(ReferenceItem<InterfaceInstanceModule> classR) {
		this.classR = classR;
	}
	public ReferenceItem<InterfaceInstanceModule> getClassR() {
		return classR;
	}
}
